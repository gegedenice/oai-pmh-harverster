...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oai="http://www.openarchives.org/OAI/2.0/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" version="2.0" exclude-result-prefixes="xs oai dc dcterms">
  ...
  <xsl:template match="/*">
    ...
    <xsl:call-template name="recursion">
      <xsl:with-param name="file_uri" select="$file_uri"/>
